...
chartRadialbarBasicColors && (options = {
    ...
    colors: chartRadialbarBasicColors
}, (chart = new ApexCharts(document.querySelector("#new_jobs_chart"), options)).render()), (chartRadialbarBasicColors = getChartColorsArray("new_jobs_chart_two")) && (options = {
    series: [80],
    chart: {
        type: "radialBar",
        width: 105,
    ...
    colors: chartRadialbarBasicColors
}, (chart = new ApexCharts(document.querySelector("#new_jobs_chart_two"), options)).render()), (chartRadialbarBasicColors = getChartColorsArray("new_jobs_chart_three")) && (options = {
    series: [80],
    chart: {
        type: "radialBar",
        width: 105,
    ...
    colors: chartRadialbarBasicColors
}, (chart = new ApexCharts(document.querySelector("#new_jobs_chart_three"), options)).render());